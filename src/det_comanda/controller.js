...
class DetComandaController {
    ...
    async updateDetComanda (req, res) {
        try {
            const datosUsuario = await ServiceToken.ValidateToken(req, res);
    ...
    async deleteDetComanda (req, res) {
        try {
            const datosUsuario = await ServiceToken.ValidateToken(req, res);
...
module.exports = new DetComandaController();
